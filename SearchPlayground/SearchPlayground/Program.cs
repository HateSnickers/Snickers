    ...
    internal class Program
    {
        ...
        static int BinarySearch(int[] array, int elementToSearch)
        {
            ...
            while (min <= max)
            {
                ...
                {
                    Console.WriteLine($"    Interval se musel rozdělit {steps} krát");
                    return mid;
                }
        ...
        static int BinarySearchRecursive(int[] array, int elementToSearch, int min, int max)
        {
            ...
            if (array[mid] < elementToSearch)
            {
                return BinarySearchRecursive(array, elementToSearch, mid+1, max);
            }
            return BinarySearchRecursive(array, elementToSearch, min, mid -1);
        }
