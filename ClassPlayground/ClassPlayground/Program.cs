...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            while (true) 
            {
                Console.WriteLine("Vyberte možnosti: (1) Rectangle, (2) Student, (3) BankAccount, (4) Ukončit");
        ...
        static void Rectangle()
        {
            ...
            float widthInput = float.Parse(Console.ReadLine());
            ...
            Console.WriteLine($"Obdélník je široký {widthInput}cm a vysoký {heightInput}cm");
            myRectangle.CalculateArea();
            myRectangle.DetermineRectangleType();
            Console.ReadKey();
        }
        static void BankAccount()
        {
            Console.Write("Zadejte jméno: ");
            float AccountNumberInput = float.Parse(Console.ReadLine());
            Console.Write("Zadejte jméno: ");
            float nameInput = float.Parse(Console.ReadLine());
            Console.Write("Zadejte jméno: ");
            float currencyInput = float.Parse(Console.ReadLine());
            Console.Write("Zadejte jméno: ");
            float BalanceInput = float.Parse(Console.ReadLine());

            BankAccount newBankAccount = new BankAccount(AccountNumberInput,nameInput, currencyInput, BalanceInput);
        }
        static void Student()
        {
